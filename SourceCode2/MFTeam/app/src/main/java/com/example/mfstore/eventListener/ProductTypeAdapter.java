...
import com.example.mfstore.ProductTypeDetailsActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, ProductTypeDetailsActivity.class);
                intent.putExtra("type", productTypeModels.getType());
