...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHold> {
    ...
    public NewsViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View rowView = inflater.inflate(R.layout.fragment_news_details, parent,false);
